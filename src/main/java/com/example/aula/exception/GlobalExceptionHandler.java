...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NumerodaCamisaJaCadastradoException.class)
    public ResponseEntity<Map<String, Object>> handlerEmailJaCadastrado(NumerodaCamisaJaCadastradoException erro) {
        return ResponseEntity
